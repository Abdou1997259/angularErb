...
@Component({
  selector: 'app-emp-class-list',
  templateUrl: './emp-class-list.component.html',
  styleUrls: ['./emp-class-list.component.css']
})
export class EmpClassListComponent extends BaseComponent implements OnInit {
 ...
 lang:any;
  ...
  LoadTransactions(page: number = 0) {
    ...
    this._Service.GetAllEmpClass(page, this.pageSize, this.searchString).subscribe((data)=>{
