...
export class NationalityListComponent extends BaseComponent implements OnInit {
 ...
 blalanceList;
 branch:any;
 idColName:any="n_nationality_id ";
 formID:any=1415;
 lang:any;
  ...
  LoadTransactions(page: number = 0) {
    ...
    this._Service.GetAllNationalities(page, this.pageSize, this.searchString).subscribe((data)=>{
      this.NationalityList = data.modelNameLST;
