...
import { EmpClassGroupsService } from 'src/app/Core/Api/HR/emp-class-groups.service';
...
@Component({
  selector: 'app-emp-class-group-list',
  templateUrl: './emp-class-group-list.component.html',
  styleUrls: ['./emp-class-group-list.component.css']
})
export class EmpClassGroupListComponent extends BaseComponent implements OnInit {
  ...
  constructor(
    private _Service:EmpClassGroupsService,
 ...
 lang:any;
  ...
  LoadTransactions(page: number = 0) {
    ...
    this._Service.GetAllEmpClassGroups(page, this.pageSize, this.searchString).subscribe((data)=>{
      this.EmpClassList = data.modelNameLST;
