...
import { VacationService } from 'src/app/Core/Api/HR/vacation.service';
...
export class VacationListComponent extends BaseComponent implements OnInit {
  ...
  constructor(
    private _Service:VacationService,
 ...
 lang:any;
  ...
  LoadTransactions(page: number = 0) {
    ...
    this._Service.GetAllVacation(page, this.pageSize, this.searchString).subscribe((data)=>{
      this.VacationList = data.modelNameLST;
