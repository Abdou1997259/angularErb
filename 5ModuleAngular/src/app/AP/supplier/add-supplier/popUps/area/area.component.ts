...
export class AreaComponent implements OnInit {
  ...
  constructor(private _SERVICE: Supplier, public dialogRef: MatDialogRef<AreaComponent>
  ...
  debugger;
    ...
    this._SERVICEPOP.getAreaLKP(page, this.pageSize, this.searchString).subscribe((data) => {
      debugger;
