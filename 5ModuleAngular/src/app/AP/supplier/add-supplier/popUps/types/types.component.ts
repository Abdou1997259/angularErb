...
export class TypesComponent implements OnInit {
  ...
  constructor(private _SERVICE: Supplier, public dialogRef: MatDialogRef<TypesComponent>
  ...
  getItemsDetailsLKP(page: number = 0) {
    ...
    this._SERVICEPOP.GetTypesLKP(page, this.pageSize, this.searchString).subscribe((data) => {
