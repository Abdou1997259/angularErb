...
export class CommissionComponent implements OnInit {
  ...
  constructor(private _SERVICE: Supplier, public dialogRef: MatDialogRef<CommissionComponent>,
  ...
  getItemsDetailsLKP(page: number = 0) {
    ...
    this._SERVICEPOP.getCommissionLKP(page, this.pageSize, this.searchString).subscribe((data) => {
