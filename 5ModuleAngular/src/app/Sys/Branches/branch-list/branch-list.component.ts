...
export class BranchListComponent extends BaseComponent implements OnInit {
  ...
  constructor(
    ...
    ,private _SERIVEC:BranchConfigService,private _router  : Router
...
LoadStores(page: number = 0){
  ...
  this._SERIVEC.GetAllBranchConfig(page, this.pageSize, this.searchString).subscribe((data)=>{
    debugger
    this.BranchData = data.modelNameLST;
