...
export class ARComponent implements OnInit {
  ...
  LoadData()
  {
    this._DashboardService.GetARSalesTotal().subscribe((data) => {
      this.salesTotal=data.value;
    });
    this._DashboardService.GetARSalesReturnTotal().subscribe((data) => {
      this.salesReturnTotal=data.value;
    });
    this._DashboardService.GetARTopSalesmen().subscribe((data) => {
      this.top10Salesmen=data;
    });
    this._DashboardService.GetARMonthSales().subscribe((data) => {
      this.monthlySales=data;
    });
    this._DashboardService.GetARCountCustomers().subscribe((data) => {
      this.customerCount=data.value;
    });
  }
